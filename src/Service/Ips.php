 ...
 */
class Ips extends Mandrill\Service
{
    /**
     * Constructs the internal representation of the Mandrill IPs service.
     */
    ...
    {
        return $this->client->request('ips/list');
    }
    ...
    public function info($ip)
    {
        ...
        return $this->client->request('ips/info', $params);
    }
    ...
    public function provision($warmup = false, $pool = null)
    {
        ...
        return $this->client->request('ips/provision', $params);
    }

    /**
     * Begins the warmup process for a dedicated IP. During the warmup
     * process, Mandrill will gradually increase the percentage of your
     * mail that is sent over the warming-up IP, over a period of roughly
     * 30 days. The rest of your mail will be sent over shared IPs or
    ...
    public function startWarmup($ip)
    {
        ...
        return $this->client->request('ips/start-warmup', $params);
    }
    ...
    public function cancelWarmup($ip)
    {
        ...
        return $this->client->request('ips/cancel-warmup', $params);
    }
    ...
    public function setPool($ip, $pool, $create_pool = false)
    {
        ...
        return $this->client->request('ips/set-pool', $params);
    }
    ...
    public function delete($ip)
    {
        ...
        return $this->client->request('ips/delete', $params);
    }
    ...
    {
        return $this->client->request('ips/list-pools');
    }
    ...
    public function poolInfo($pool)
    {
        ...
        return $this->client->request('ips/pool-info', $params);
    }

    /**
     * Creates a pool and returns it. If a pool already exists with
     * this name, no action will be performed.
     *
    ...
    public function createPool($pool)
    {
        ...
        return $this->client->request('ips/create-pool', $params);
    }

    /**
     * Deletes a pool. A pool must be empty before you can delete
     * it, and you cannot delete your default pool.
     *
    ...
    public function deletePool($pool)
    {
        ...
        return $this->client->request('ips/delete-pool', $params);
    }
    ...
    public function checkCustomDns($ip, $domain)
    {
        ...
        return $this->client->request('ips/check-custom-dns', $params);
    }
    ...
    public function setCustomDns($ip, $domain)
    {
        ...
        return $this->client->request('ips/set-custom-dns', $params);
    }
}