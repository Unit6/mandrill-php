...
/**
 * Mandrill Rejects Class.
 *
 * @author Unit6 <team@unit6websites.com>
 */
class Rejects extends Mandrill\Service
{
    /**
     * Constructs the internal representation of the Mandrill Rejects service.
     */
    ...
    public function add(Model\Address $address)
    {
        ...
        return $this->client->request('rejects/add', $params);
    }
    ...
    public function getList($email = null, $include_expired = false, $subaccount = null)
    {
        ...
        return $this->client->request('rejects/list', $params);
    }
    ...
    public function delete($email, $subaccount = null)
    {
        ...
        return $this->client->request('rejects/delete', $params);
    }
}