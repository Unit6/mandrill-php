...
/**
 * Mandrill Senders Class.
 *
 * @author Unit6 <team@unit6websites.com>
 */
class Senders extends Mandrill\Service
{
    /**
     * Constructs the internal representation of the Mandrill Senders service.
     */
    ...
    {
        return $this->client->request('senders/list');
    }
    ...
    {
        return $this->client->request('senders/domains');
    }

    /**
     * Adds a sender domain to your account. Sender domains are added
     * automatically as you send, but you can use this call to add
     * them ahead of time.
     *
    ...
    public function addDomain($domain)
    {
        ...
        return $this->client->request('senders/add-domain', $params);
    }

    /**
     * Checks the SPF and DKIM settings for a domain. If you haven't
     * already added this domain to your account, it will be added automatically.
     *
     * @param string $domain a domain name
     *
    ...
    public function checkDomain($domain)
    {
        ...
        return $this->client->request('senders/check-domain', $params);
    }

    /**
     * Sends a verification email in order to verify ownership of a domain.
     * Domain verification is an optional step to confirm ownership of a domain.
     * Once a domain has been verified in a Mandrill account, other accounts
     * may not have their messages signed by that domain unless they also verify
     * the domain. This prevents other Mandrill accounts from sending mail signed
     * by your domain.
     *
    ...
    public function verifyDomain($domain, $mailbox)
    {
        ...
        return $this->client->request('senders/verify-domain', $params);
    }
    ...
    public function info($address)
    {
        ...
        return $this->client->request('senders/info', $params);
    }
    ...
    public function timeSeries($address)
    {
        ...
        return $this->client->request('senders/time-series', $params);
    }
}