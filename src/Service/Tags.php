 ...
 */
class Tags extends Mandrill\Service
{
    /**
     * Constructs the internal representation of the Mandrill Tags service.
     */
    ...
    {
        return $this->client->request('tags/list');
    }
    ...
    public function delete($tag)
    {
        ...
        return $this->client->request('tags/delete', $params);
    }
    ...
    public function info($tag)
    {
        ...
        return $this->client->request('tags/info', $params);
    }

    /**
     * Return the recent history (hourly stats for the last 30 days) for a tag or all tags.
     *
     * @param string|null $tag an existing tag name
     *
     ...
     */
    public function timeSeries($tag = null)
    {
        $uri = 'tags/';
